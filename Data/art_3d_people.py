...
def getData():
    return {
        "description": "Put yourself in the role of a 3D designer who works with 3D modeling only for realistic characters",
        "file": "art_3d_people", ## Archivo dentro del directorio "tuning"
        "params": { # Parámetros para configurar las peticiones api a Stable Diffusion
            ...
            "restore_faces": False,
            "before_prompt": "A 3d digital portrait render of",
            ...
            "extra_prompt": "(render 3d:1.5), digital art, digital render, digital rendering, (detailed face:1.5), (detailed clothes:1.4), (extremely detailed eyes and face), foreground, detailed face, perfect mouth, 3d photography, highly detailed, sharp focus, stunningly beautiful, high quality photography, high detailed skin, (full body:1.5), (only one person:1.1), (close up camera:1.5), fantasy character, detailed 3d render, uhd, 8k, overdetailed art, concept art, full body shot, photorealistic, (character centered in the image:1.4), ultra high detail, ultra realistic"
        },
        "lora": [
            "", "shuimobysim",
