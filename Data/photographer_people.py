...
def getData():
    return {
        ...
        "params": { # Parámetros para configurar las peticiones api a Stable Diffusion
            ...
            "extra_prompt": "mdjrny-v4, detailed face, perfect mouth, photography, highly detailed, sharp focus, stunningly beautiful, 8k"
        },
        "scenes": [
        ...
        "tags": [
            ...
            "Close-Up Portrait", "Full-Body Portrait", "Group Portrait", "Child Portrait", "Adult Portrait",
            "Elderly Portrait", "Artistic Portrait", "Fashion Portrait", "Classic Portrait", "Contemporary Portrait",
            "Conceptual Portrait", "Natural Portrait", "Celebrity Portrait", "Friend Portrait", "Family Portrait",
            "Couple Portrait", "Children's Portrait", "Teen Portrait", "Model Portrait", "Musician Portrait",
            ...
            "Dramatic Portrait", "Sensual Portrait", "Formal Portrait", "Casual Portrait", "Headshot", "Family Portrait",
            "Group Portrait", "Children's Portrait", "Teenage Portrait", "Elderly Portrait", "Engagement Portrait",
        ...
        "elements": [
            "People", "Model", "Celebrity", "Child", "Adult", "Elderly", "Man", "Woman", "Couple", "Group",
